CREATE TABLE ITEM(ID VARCHAR(255) NOT NULL PRIMARY KEY,TITLE VARCHAR(255) NOT NULL,LINK VARCHAR(255) NOT NULL,DESCRIPTION VARCHAR(255) NOT NULL,CONTENT VARCHAR(255) NOT NULL,TIME DATE NOT NULL,NEWSFEED_ID VARCHAR(255))
CREATE TABLE USER(ID VARCHAR(255) NOT NULL PRIMARY KEY,NAME VARCHAR(255) NOT NULL,CONSTRAINT SYS_CT_341 UNIQUE(NAME))
CREATE TABLE NEWSFEED(ID VARCHAR(255) NOT NULL PRIMARY KEY,URL VARCHAR(255) NOT NULL,CONSTRAINT SYS_CT_343 UNIQUE(URL))
CREATE TABLE SUBSCRIPTION(ID VARCHAR(255) NOT NULL PRIMARY KEY,NAME VARCHAR(255) NOT NULL,NEWSFEED_ID VARCHAR(255),USER_ID VARCHAR(255),CONSTRAINT FK1456591DF73AEE0F FOREIGN KEY(USER_ID) REFERENCES USER(ID),CONSTRAINT FK1456591DB7087129 FOREIGN KEY(NEWSFEED_ID) REFERENCES NEWSFEED(ID))
ALTER TABLE ITEM ADD CONSTRAINT FK317B13B7087129 FOREIGN KEY(NEWSFEED_ID) REFERENCES NEWSFEED(ID)
