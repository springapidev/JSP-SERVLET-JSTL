...
public class HibeAggregatorDAO implements AggregatorDAO
{
  ...
  public User getUser(String name) throws DAOException {
    ...
    try {
      ...
      String hql = "from user in class com.apress.projsp.User where name=?";
      ...
      throws DAOException
  {
    ...
    try {
      ...
      Newsfeed feed = null;
      String hql = "from feed in class com.apress.projsp.Newsfeed where feed.url=?";
      Query query = ses.createQuery(hql);
  ...
  public List getAllNewsfeeds() throws DAOException {
    ...
    try {
      ses = sessionFactory.openSession();
      String hql = "from newsfeed in class com.apress.projsp.Newsfeed";
      Query query = ses.createQuery(hql);
      feeds = query.list();
    } catch (Exception e) {
      throw new DAOException(e);
  ...
  public void removeNewsfeed(Newsfeed feed) throws DAOException {
    ...
    /*
     * If database does not cascade deletes, you'd need to do this:
     * 
  ...
  public void addItem(Newsfeed feed, Item item) throws DAOException {
    ...
    try {
      ...
      feed = (Newsfeed) ses.load(com.apress.projsp.Newsfeed.class, feed
          .getId());
  ...
  /**
   * @see com.apress.projsp.AggregatorDAO#getRecentItems(int)
   */
  public List getRecentItems() throws DAOException {
    ...
    try {
      ses = sessionFactory.openSession();
      String hql = "select i from i in class com.apress.projsp.Item "
  ...
  /**
   * @see com.apress.projsp.persist.AggregatorDAO#getPopularItems(int)
   */
  public List getPopularItems() throws DAOException {
    ...
    try {
      ses = sessionFactory.openSession();
      String hql = "from item in class com.apress.projsp.Item "
  ...
  /**
   * @see com.apress.projsp.persist.AggregatorDAO#getRecentlyUpdatedNewsfeeds(int)
   */
  public List getRecentlyUpdatedNewsfeeds() throws DAOException {
    ...
    try {
      ses = sessionFactory.openSession();
      String hql = "from feed in class com.apress.projsp.Newsfeed "
                   + "order by feed.updated desc";
      Query query = ses.createQuery(hql);
      feeds = query.list();
    } catch (Exception e) {
      throw new DAOException(e);
  ...
  /**
   * @see com.apress.projsp.persist.AggregatorDAO#updateNewsfeed(Newsfeed,
   *      Date)
   */
  public void updateNewsfeed(Newsfeed feed, String title)
      throws DAOException
  {
    feed.setName(title);
    storeNewsfeed(feed);
  ...
  /**
   * @see com.apress.projsp.persist.AggregatorDAO#hitItem(java.lang.String)
   */
