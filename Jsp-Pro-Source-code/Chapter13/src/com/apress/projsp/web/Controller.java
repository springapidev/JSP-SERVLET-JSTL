...
public class Controller extends HttpServlet
{
      ...
      throws ServletException, IOException
  {
    ...
    if (action != null) {
      if (req.getSession(true).getAttribute("user") == null
          && !(action instanceof MainAction)
          && !(action instanceof LinkAction)) {
        action = mLoginAction;
      }
  ...
  public void init(ServletConfig config) throws ServletException {
    try {
      ...
      mActions.put("/main", new MainAction(config.getServletContext()));
      mActions.put("/maincache", new MainAction(config.getServletContext()));
      ...
      mActions.put("/subs", new SubscriptionAction(config
          .getServletContext()));
      mActions.put("/link", new LinkAction(config.getServletContext()));
    } catch (Exception e) {
