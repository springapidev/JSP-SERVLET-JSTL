<html>
  ...
  <body>
    ...
    <%@ taglib prefix="tags" uri="http://www.apress.com/projsp/ch06" %>
    ...
    <table width="100%">
      ...
      <tr>
        <td valign="top">
          <h1>Welcome</h1>
          Welcome to the Apress online store - here you can learn about and buy books through our secure server.
        </td>
        <td align="right">

          <tags:box color="#CC0033" title="Pro JSP 2, 4th Edition">
            Pro JSP 2, 4th Edition is 
          ...
          <tags:box color="#314289" title="Beginning Java Objects: From Concepts to Code">
